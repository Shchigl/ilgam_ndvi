...
var lyr_ndvi_sentinel_small_1 = new ol.layer.Image({
                            opacity: 1,
                            title: "ndvi_sentinel_small",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/ndvi_sentinel_small_1.png",
    attributions: ' ',
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                imageExtent: [3394208.000770, 6515752.015853, 3427927.869614, 6537970.353128]
                            })
                        });
...
lyr_OSMStandard_0.setVisible(true);lyr_ndvi_sentinel_small_1.setVisible(true);lyr_Dneprovskiy_2.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_ndvi_sentinel_small_1,lyr_Dneprovskiy_2];
